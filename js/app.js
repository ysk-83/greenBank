(() => {
    ...
    function initSliders() {
        if (document.querySelector(".slider-testimonial__body")) {
            ...
            const enableSwiper = function() {
                mySwiper = new swiper_core_Swiper(".slider-testimonial__body", {
                    modules: [ Navigation ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: 1.2,
    ...
    function addAnimation() {
        scrollers.forEach((scroller => {
            ...
            for (let i = 0; i < 11; i++) scrollerContent.forEach((item => {
    ...
    function drawSiteLine() {
        let path = document.querySelector(".line path");
        let pathLength = path.getTotalLength();
        path.style.strokeDasharray = pathLength + " " + pathLength;
        path.style.strokeDashoffset = pathLength;
        window.addEventListener("scroll", (() => {
            let scrollPersentage = (document.documentElement.scrollTop + document.body.scrollTop) / (document.documentElement.scrollHeight - document.documentElement.clientHeight);
